...
import com.example.devsu.exception.movimiento.InvalidMovimientoTypeException;
import com.example.devsu.exception.movimiento.MovimientoNotFoundException;
import com.example.devsu.exception.movimiento.SaldoNoDisponibleException;
import com.example.devsu.repository.CuentaRepository;
import com.example.devsu.repository.MovimientoRepository;
...
public class MovimientoServiceImpl implements MovimientoService {
    ...
    public Movimiento saveMovimiento(MovimientoDTO movimientoDTO) {
        ...
        Optional<Cuenta> cuentaOpt = cuentaRepository.findByNumeroCuenta(movimientoDTO.getNumeroCuenta());
    ...
    public MovimientoDTO updateMovimiento(MovimientoDTO movimientoDTO) {
        ...
        String movimientoId = movimientoDTO.getId();
